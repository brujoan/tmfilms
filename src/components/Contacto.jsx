...
const IconoWhatsapp = ({ className = "w-6 h-6 inline-block mr-2 align-middle" }) => (
  <svg height="100%" style={{fillRule:"evenodd",clipRule:"evenodd",strokeLinejoin:"round",strokeMiterlimit:2}} version="1.1" viewBox="0 0 512 512" width="100%" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" className={className}>
...
const IconoInstagram = ({ className = "w-6 h-6 inline-block mr-2 align-middle" }) => (
...
const IconoMail = ({ className = "w-8 h-8 inline-block mr-2 align-middle" }) => (
    ...
    <div ref={ref} className="border-b border-neutral-900 pb-20">
      ...
      <div className="text-center tracking-tighter">
        <div className="my-4 flex justify-center items-center">
          <motion.a
            href="https://www.instagram.com/tmfilmsproductora"
            target="_blank"
            rel="noopener noreferrer"
            whileInView={{ opacity: 1, x: 0 }}
            initial={{ opacity: 0, x: -20 }}
            transition={{ duration: 0.7, delay: 0.35 }}
            className="inline-flex items-center font-humaroid font-bold text-2xl"
          >
            <IconoInstagram /> @tmfilmsproductora
          </motion.a>
        </div>
        <div className="my-4 flex justify-center items-center">
          <motion.a
            ...
            className="inline-flex items-center font-humaroid font-bold text-2xl"
          ><IconoWhatsapp />{CONTACTO.phoneNo}</motion.a>
        </div>
        <div className="my-4 flex justify-center items-center">
          <motion.a
            whileInView={{ opacity: 1, x: 0 }}
